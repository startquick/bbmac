...
input string Item3  = "Reentry Arrow Confirmed";    // Green/Red only!
input string Item4  = "H1 Filter Passed";            // Conservative filter OK
input string Item5  = "Multi-TF Alignment OK";       // MD1, MW aligned
input string Item6  = "Entry Zone Valid";            // Price at LWMA
input string Item7  = "Stop Loss Calculated";
input string Item8  = "Risk 1-2% Max";               // FIXED: was 5-10%!
input string Item9  = "Take Profit Set";
input string Item10 = "No High Impact News";         // News filter
...
input int   InputPanelOffsetY  = 50;   // pixels from TOP
...
// Toggle (bottom-RIGHT corner, 50px from bottom (BBMAC is at 25px))
input int   ToggleOffsetX      = 25;   // pixels from RIGHT
input int   ToggleOffsetY      = 50;   // pixels from BOTTOM
